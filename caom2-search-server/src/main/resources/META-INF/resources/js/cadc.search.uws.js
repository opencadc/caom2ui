(function ($)
{
  ...
  function UWSJobLoader(_jobURL)
  {
    ...
    {
      var jobParser =
          new ca.nrc.cadc.search.uws.xml.UWSJobParser($xmlData);
  ...
  function UWSJSONJobParser(json)
  {
    ...
    function init()
    {
      _selfParser.job = new ca.nrc.cadc.search.uws.UWSJob(json.id, json.runID,
                                                          json.ownerID,
                                                          json.phase,
                                                          json.parameters);
    }
  ...
  function UWSXMLJobParser($uwsXML)
  {
    ...
    {
      var parameters = {};
      $uwsXML.find("uws\\:parameter, parameter").each(
          function ()
          {
            var $nextParam = $(this);
