(function ($)
{
    ...
    function DialogColumnPicker(_columns, _grid, _options)
    {
        ...
        this.$modal = $("#column_manager_container");
        // todo: convert this to bootstrap popover
        this.$selectedItems =
        ...
        function init()
        {
            ...
            {
                if (args.$menu.attr("id") === selfColumnPicker.$selectedItems.attr("id"))
                {
                    setColumns();
                }
            });
            ...
            var $showAllButton = $("<button type='button' class='btn btn-sm btn-default column_manager_buttons'></button>").text(
                getOption("showAllButtonText")).appendTo($buttonHolder);

            var $resetButton = $("<button type='button' class='btn btn-sm btn-default column_manager_buttons'></button>").text(
            ...
            var alphaButtonHTML =
                "<button type='button' class='btn btn-sm btn-default'>&darr;&nbsp;&uarr;</button>";
            ...
            var $fluidContainer = $("<div class='container-fluid'>");
            var $mainContainer = $("<div class='row' />");
                ...
                $.extend({},
                    {
                        ...
                        "stop": onStop,
                        "over": onHover,
                        "appendTo": selfColumnPicker.$modal
                    },
            ...
            selfColumnPicker.$modal.find(
                getOption(cadc.vot.picker.DIALOG_CLOSE_SELECTOR_KEY)).click(
                function ()
                {
                    selfColumnPicker.$modal.modal("hide");
                    return false;
                });
