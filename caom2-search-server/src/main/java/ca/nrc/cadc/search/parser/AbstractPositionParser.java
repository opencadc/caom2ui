...
public abstract class AbstractPositionParser
{
     ...
     */
    public TargetData parse(final String target)
            ...
            throws PositionParserException
    {
        try
        {
            ...
            final String[] parts = sanitizedTarget.trim().split("\\s+");
     ...
     */
    private boolean parseRadius(final String radius, TargetData targetData)
    {
        try
        {
