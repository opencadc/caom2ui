        ...
        extends AbstractUnitTest<ObservationListQueryGenerator>
{
    ...
    public void detail1() throws Exception
    {
        ...
        sql = getTestSubject().getSelectSQL(
                new ArrayList<SearchTemplate>()).toString();
        log.debug("OUT: " + sql);
    ...
    @Test
    public void freqWidthQuery() throws Exception
    {
        setTestSubject(
                new ObservationListQueryGenerator(null, null, null, null));

        final List<SearchTemplate> tmpl = new ArrayList<SearchTemplate>();
        ...
        log.debug(" IN: Observation");
        final String sql = getTestSubject().getSelectSQL(tmpl).toString();
        log.debug("OUT: " + sql);
