...
public class VOTableOutputStream implements OutputStreamWrapper
{
    private InputStream inputStream;
    private UploadResults uploadResults;
    private final TargetNameResolverClient targetNameResolverClient;

    public VOTableOutputStream(InputStream inputStream,
                               UploadResults uploadResults,
                               TargetNameResolverClient targetNameResolverClient)
    {
