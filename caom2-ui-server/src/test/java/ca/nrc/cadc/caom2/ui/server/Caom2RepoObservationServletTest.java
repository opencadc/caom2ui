...
public class Caom2RepoObservationServletTest {
    ...
    public void doGetCollectionsList() throws Exception {
        ...
        replay(mockRequest, mockDisplayDispatcher, mockResponse);

        final Caom2RepoObservationServlet testSubject = new Caom2RepoObservationServlet(testClient, observationUtil);
        testSubject.doGet(mockRequest, mockResponse);

        verify(mockRequest, mockDisplayDispatcher, mockResponse);
    }
    ...
    public void doObservationList() throws Exception {
        ...
        expect(mockRequest.getRequestDispatcher("/obslist.jsp")).andReturn(mockDisplayDispatcher).once();
        mockDisplayDispatcher.forward(mockRequest, mockResponse);
        expectLastCall().once();
    ...
    public void doGetNullObservation() throws Exception {
        ...
        final Caom2RepoClient testClient =
            new Caom2RepoClient() {
                 ...
                 */
                @Override
                public Observation getObservation(Subject subject, ObservationURI uri) {
                    return null;
                }
            };
