...
public class PositionParserException extends Exception
{
    ...
    public PositionParserException(String message)
    {
        super(message);
    }
     ...
     * @param cause
     */
    public PositionParserException(Throwable cause)
    {
        super(cause);
    }
     ...
     * @param cause
     */
    public PositionParserException(String message, Throwable cause)
    {
        super(message, cause);
    }
