...
public class ColumnUnitServlet extends HttpServlet
{
    ...
    {
        final Map<String, String> integrationTimeUnitMap =
        ...
        final Map<String, String> spatialRAUnitMap =
                new LinkedHashMap<String, String>();

        spatialRAUnitMap.put("H:M:S", "SEXAGESIMAL");
        spatialRAUnitMap.put("Degrees", "DEGREES");

        final Map<String, String> spatialDecUnitMap =
                new LinkedHashMap<String, String>();
        ...
        final Map<String, String> wavelengthUnitMap =
                new LinkedHashMap<String, String>();
        ...
        final Map<String, String> dateUnitMap =
                new LinkedHashMap<String, String>();
            ...
            throws IOException, JSONException
    {
        ...
        if (columnNames != null)
        {
            for (final String columnName : columnNames)
            {
                ...
                if (!MAIN_CACHE.containsKey(columnName))
                {
                    unitMap = new HashMap<String, String>();
                }
                else
                {
                    unitMap = MAIN_CACHE.get(columnName);
                }
